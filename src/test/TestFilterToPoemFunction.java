...
public class TestFilterToPoemFunction {
    ...
    public void testFTPF() {
        ...
        assertEquals(poemParser.filterToPoem((poemText), "The Raven", "Shall be lifted nevermore"), filteredPoem);
    }
}
